...
nmap <silent> [d <Plug>(coc-diagnostics-prev)
nmap <silent> ]d <Plug>(coc-diagnostics-next)
...
nmap <silent> <space>f :CocCommand explorer<CR>
" nmap <space>f :CocCommand explorer --preset floating<CR>
nmap <silent> <space>b :CocCommand explorer --sources=buffer+<CR>
